...
impl LauncherPaths {
    ...
    pub fn create_layout(&self) -> AppResult<()> {
        ...
        for directory in [
            ...
            &self.logs,
            &self.launcher_logs,
            // SNine dedicated Minecraft layout. The launcher must never fall back
            // to the user's normal .minecraft directory.
            &self.root.join("instances"),
            &self.root.join("instances").join("SNine Client"),
            &self.root.join("versions"),
            &self.root.join("libraries"),
            &self.root.join("java"),
            &self.root.join("skins"),
            &self.root.join("cosmetics"),
        ] {
