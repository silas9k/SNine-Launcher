...
const frontend = [read("src/lib/cloudSyncCommands.ts"), read("src/pages/AccountsPage.tsx")].join("\n");
const errors = [];
...
if (!frontend.includes("<Button disabled>")) errors.push("cloud account linking is not visibly fail-closed");
