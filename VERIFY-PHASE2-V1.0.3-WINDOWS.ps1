...
$expectedArchiveName = "S9Lab-Launcher-Phase2-v1.0.3-final-source.zip"
$expectedRootName = "S9Lab-Launcher-Phase2-v1.0.3-final-source"
...
$verificationRoot = Join-Path $systemTempRoot ("S9Lab-Phase2-v1.0.3-Verify-" + [guid]::NewGuid().ToString("N"))
...
Invoke-Checked -Label "Vollständiges Phase-2-Verifikationsskript" -File "npm" -Arguments @("run", "verify:phase2") -WorkingDirectory $projectRoot
